...
public class MainRequestImpl extends BaseRequest implements MainRequest {
    ...
    @Override
    public Observable<SuccessResponse> requestUpload(String id, String nameImage, String image, String sheet) {
        return CoreApp.getAPiCore().getApiService().postUpload(id, nameImage, image, sheet)
